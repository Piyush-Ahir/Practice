...
public class CreateOrgWithPhoneTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		String industryName = elib.getDataFromExcel("Sheet3", 4, 3);
		String typeName = elib.getDataFromExcel("Sheet3", 4, 4);
		String phoneNum = elib.getDataFromExcel("Sheet3", 7, 3);
		...
		wdlib.sendKeysToElement(By.id("phone"), phoneNum);
		...
		if (verifyPhone.equals(phoneNum)) {
			System.out.println(phoneNum + " selected Successfully!!!");
		}
